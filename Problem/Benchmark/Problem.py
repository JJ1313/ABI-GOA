...
def fitness(problem, individuo):
    fitness = 0
    if problem == 'F1':
        fitness = F1(individuo)
    if problem == 'F2':
        fitness = F2(individuo)
    if problem == 'F3':
        fitness = F3(individuo)
    if problem == 'F4':
        fitness = F4(individuo)
    if problem == 'F5':
        fitness = F5(individuo)
    if problem == 'F6':
        fitness = F6(individuo)
    if problem == 'F7':
        fitness = F7(individuo)
    if problem == 'F8':
        fitness = F8(individuo)
    if problem == 'F9':
        fitness = F9(individuo)
    if problem == 'F10':
        fitness = F10(individuo)
    if problem == 'F11':
        fitness = F11(individuo)
